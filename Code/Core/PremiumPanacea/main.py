...
def Main() -> None:
    ...
    Banner(Fore.YELLOW, "PANACEA", f"The thing, that'll get rid of the \"exp gained\" notification!\nVersion: {VERSION_MAJOR}.{VERSION_MINOR} -- premium account version by Wormyy")
    
    action : str = input("1. Fix the bug\n2. Leave\n\n>>> ")
...
def ConfigChanger() -> None:
    ...
    try:
        ...
        Banner(Fore.RED, "An error occurred!", f"Here's an error: {e}")
        Escape()
